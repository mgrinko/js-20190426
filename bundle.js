...
/* harmony import */ var _Basket_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17);
/* harmony import */ var _Filter_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(18);
/* harmony import */ var _PhonesCatalog_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(19);
/* harmony import */ var _PhoneViewer_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(20);
/* harmony import */ var _api_phone_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(21);
...
function (_Component) {
  ...
  function PhonesPage(element) {
    ...
    _this.showPhone = function (phoneId) {
      Object(_api_phone_js__WEBPACK_IMPORTED_MODULE_11__["getById"])(phoneId).then(function (phoneDetails) {
        _this.setState({
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(PhonesPage, [{
    ...
    value: function loadPhones() {
      ...
      Object(_api_phone_js__WEBPACK_IMPORTED_MODULE_11__["getAll"])({
    ...
    value: function render() {
      ...
      this.initComponent(_PhonesCatalog_js__WEBPACK_IMPORTED_MODULE_9__["default"], {
        phones: this.state.phones,
        onPhoneSelected: this.showPhone,
        onAdd: this.addBasketItem
      });
      this.initComponent(_PhoneViewer_js__WEBPACK_IMPORTED_MODULE_10__["default"], {
        phone: this.state.selectedPhone,
        onBack: this.hidePhone,
        onAdd: this.addBasketItem
      });
      this.initComponent(_Basket_js__WEBPACK_IMPORTED_MODULE_7__["default"], {
        items: this.state.basketItems,
        onDelete: this.deleteBasketItem
      });
      this.initComponent(_Filter_js__WEBPACK_IMPORTED_MODULE_8__["default"], {
        query: this.state.query,
        sortField: this.state.sortField,
...
function (_Component) {
  ...
  function Basket(element, props) {
    ...
    _this.on('click', 'delete-button', function (event) {
      var index = +event.delegateTarget.dataset.itemIndex;
...
var API_URL = "https://mgrinko.github.io/js-20190426/api"; // const API_URL = `http://127.0.0.1:3000/api`;
...
var getAll = function getAll(params) {
  return fetch("".concat(API_URL, "/phones.json?query=").concat(params.query, "&sortField=").concat(params.sortField)).then(function (res) {
    return res.json();
  }).then(function (phones) {
    var normalizedQuery = params.query.toLowerCase();
    var key = params.sortField;
